...
- Feature matrix across SDK, backend, frontend
- User flow map with gaps
- Parity positioning vs Grafana/Datadog/Sentry
- Keep/Fix/Remove/Defer + phased roadmap with acceptance criteria
