...
| `lumonox-sdk` | `sdk/pyproject.toml` | Import package **`lumonox`** for app instrumentation (`pip install lumonox-sdk`); FastAPI + Django middleware (Django via the `[django]` extra) |
