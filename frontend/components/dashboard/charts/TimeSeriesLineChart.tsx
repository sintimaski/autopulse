...
export function TimeSeriesLineChart({
  ...
  return (
    <div className="rounded-xl border border-slate-200/80 bg-gradient-to-br from-white/90 via-slate-50/80 to-amber-50/60 p-3 dark:border-neutral-700 dark:bg-gradient-to-br dark:from-neutral-900/90 dark:via-neutral-900/80 dark:to-amber-950/20">
