...
export function QueryExplorerContent() {
  ...
  return (
    <section className="rounded-2xl bg-white/95 p-6 shadow-sm ring-1 ring-slate-900/[0.06] dark:bg-neutral-900 dark:ring-white/[0.08]">
      <h2 className="text-base font-semibold text-slate-900 dark:text-neutral-100">Full query explorer</h2>
      <p className="mt-1 text-sm text-slate-500 dark:text-neutral-400">
        Runs SQL against <code>scoped_events</code> (already constrained to your project + time window).
      </p>
      <div className="mt-4 grid gap-3">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button type="button" onClick={() => void runQuery()} disabled={loading} className="ap-btn">
