    ...
    <div suppressHydrationWarning className={isDark ? "dark" : ""}>
      <div className="flex min-h-screen bg-slate-100 text-slate-900 dark:bg-neutral-950 dark:text-neutral-100">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 border-b border-slate-200/90 bg-white/95 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/95">
            ...
            <div className="border-t border-slate-100 bg-slate-50/90 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900 sm:px-6">
              {filterToolbar}
            </div>
          </header>
