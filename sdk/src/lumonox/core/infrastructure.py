"""psutil-backed host / process / disk / network sampler.

Canonical location of ``InfrastructureSampler``. The legacy import path
``lumonox._infrastructure`` re-exports the same symbol so older callers
