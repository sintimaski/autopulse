...
from lumonox_backend.repositories.runtime_controls import acquire_scheduler_lease
from lumonox_backend.services.aggregate_delta_codec import decode_aggregate_payload
from lumonox_backend.services.ingest_sql_tail_codec import decode_ingest_sql_tail_payload
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Lumonox background jobs.")
    parser.add_argument(
        "command",
        choices=(
            "alerts-once",
