...
from lumonox_backend.auth.dashboard_security import (
    _email_matches_allowed_domains,
    _forbidden,
    _hash_token,
    _normalize_email,
    _now,
    _raw_dashboard_session_token_from_request,
    _set_session_cookie,
    _unauthorized,
)
...
from lumonox_backend.services.alert_service import AlertSignal, EmailAlertSender

# Legacy default project name from older local bootstrap flows (keep for DB adoption).
_LEGACY_SINGLETON_BOOTSTRAP_PROJECT_NAME = "Lumonox Embedded Project"
